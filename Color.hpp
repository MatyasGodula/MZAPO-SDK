...
/// @details This class provides a way to create colors using RGB888 values and convert them to
/// RGB565 format.
...
struct Color {
    public:
        ...
        constexpr Color(uint8_t r, uint8_t g, uint8_t b) : value(to565(r, g, b)) {}

        /// @brief Gets the RGB565 color as a uint16_t.
        constexpr uint16_t to_rgb565() const { return value; }
    ...
    private:
        ...
        /// @param b Blue component (0-255)
        /// @return RGB565 value
        /// @note This function is called in the constructor and is not intended to be used
        /// directly.
        /// @note The conversion is done by scaling the RGB888 values to fit into the RGB565 format
        /// so detail can be lost.
